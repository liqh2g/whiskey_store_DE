...
after insert on whiskey_shop.customers 
for each row
insert into dwh_whiskey_shop.dwh_customers
select 
	c1.customer_id,
    c1.first_name,
    c1.last_name,
...
after insert on whiskey_shop.employees 
for each row
insert into dwh_whiskey_shop.dwh_employees
select 
	e.employee_id,
    e.first_name,
    e.last_name,
...
for each row
insert into dwh_whiskey_shop.dwh_fact
select 
	c.customer_id,
    e.employee_id,
    pr.product_id,
